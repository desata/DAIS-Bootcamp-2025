...
CREATE TABLE DocumentsInformation (
	...
	DocumentVersion VARCHAR(12) NOT NULL, 
...
VALUES 
('Alice Johnson', 'alice.j',	'8D969EEF6ECAD3C29A3A629280E686CF0C3F5D5A86AFF3CA12020C923ADC6C92', 1, 1),    
('Bob Smith', 'bob.s',		'8D969EEF6ECAD3C29A3A629280E686CF0C3F5D5A86AFF3CA12020C923ADC6C92', 2, 2),          
('Carol White', 'carol.w',	'8D969EEF6ECAD3C29A3A629280E686CF0C3F5D5A86AFF3CA12020C923ADC6C92', 3, 3),      
('David Lee', 'david.l',		'8D969EEF6ECAD3C29A3A629280E686CF0C3F5D5A86AFF3CA12020C923ADC6C92', 2, 2),
('Emily Chen', 'emily.c',		'8D969EEF6ECAD3C29A3A629280E686CF0C3F5D5A86AFF3CA12020C923ADC6C92', 3, 1),
('Frank Moore', 'frank.m',	'8D969EEF6ECAD3C29A3A629280E686CF0C3F5D5A86AFF3CA12020C923ADC6C92', 2, 3),
('Grace Kim', 'grace.k',		'8D969EEF6ECAD3C29A3A629280E686CF0C3F5D5A86AFF3CA12020C923ADC6C92', 3, 2),
...
('Liam Scott', 'liam.s',		'8D969EEF6ECAD3C29A3A629280E686CF0C3F5D5A86AFF3CA12020C923ADC6C92', 3, 2);
...
INSERT INTO DocumentsInformation (Content, DocumentVersion, HasOldVersions, CreateDate, DocumentId) VALUES
('Content for Agile introduction document.', 'v1.0', 0, GETDATE(), 1),
('Deep dive into C# advanced features.', 'v1.0', 0, GETDATE(), 2),
('Fundamentals of machine learning concepts.', 'v1.0', 0, GETDATE(), 3),
('Steps for migrating infrastructure to cloud.', 'v1.0', 0, GETDATE(), 4),
('DevOps tools and best practices explained.', 'v1.0', 0, GETDATE(), 5),
('Guide to identify and prevent cyber attacks.', 'v1.0', 0, GETDATE(), 6),
('QA strategies and testing methodologies.', 'v1.0', 0, GETDATE(), 7),
('How to visualize data for better insight.', 'v1.0', 0, GETDATE(), 8),
('Best practices for REST API design.', 'v1.0', 0, GETDATE(), 9),
('UX principles every designer should know.', 'v1.0', 0, GETDATE(), 10),
('Effective onboarding process in HR.', 'v1.0', 0, GETDATE(), 11),
('Performance review system guidelines.', 'v1.0', 0, GETDATE(), 12),
('How to write great technical documents.', 'v1.0', 0, GETDATE(), 13),
('Mitigating risks in project management.', 'v1.0', 0, GETDATE(), 14),
('Optimizing SQL database performance.', 'v1.0', 0, GETDATE(), 15),
('Essentials of Kubernetes orchestration.', 'v1.0', 0, GETDATE(), 16),
('Effective business analysis tools.', 'v1.0', 0, GETDATE(), 17),
('Deploying AI models in production.', 'v1.0', 0, GETDATE(), 18),
('Getting started with Git version control.', 'v1.0', 0, GETDATE(), 19),
('Complete guide for Scrum Masters.', 'v1.0', 0, GETDATE(), 20);
